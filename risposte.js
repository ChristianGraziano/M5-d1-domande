...
//? React è una libreria JavaScript open-source utilizzata per lo sviluppo di applicazioni web e mobili; è stata sviluppata da Facebook ed è diventata molto popolare nel campo dello sviluppo web negli ultimi anni.

2- ReactJS è un framework, non una libreria. (v/f) //? FALSO
...
3- Il file package.json contiene…
    ...
    -Molte informazioni utili, come ad esempio l’elenco di tutte le dipendenze  richieste dall’applicazione //? questa e quella corretta
...
5- Qual è il comando da lanciare nel terminale per creare una nuova create-react-app con nome “test”?
    - npx create-react-app test //? questa qui
...
6- Cos’è un componente React?
    ...
    - Un blocco di logica/contenuto riutilizzabile all’interno dell’applicazione //?questa e la risposta corretta
...
8- Qual è la differenza tra componenti creati come funzione e componenti creati come classe?
    - I componenti creati come funzione sono più semplici da scrivere ma con meno   funzionalità, mentre i componenti creati come classe necessitano in genere di un maggior numero di linee di codice ma possiedono più funzionalità. //?questa e quella corretta
...
9- Le props sono frammenti di informazione assegnati all’invocazione di un componente React, utili al fine di rendere il componente dinamico e più riutilizzabile. (v/f)//?VERO
10 - Le props possono essere passate solamente da un componente genitore ad un componente figlio, non è possibile fare il contrario (v/f) //?VERO
11-Da dove possono venire recuperate le props all’interno di un componente React creato come classe?
    ...
    - Possono essere recuperate all’interno dello oggetto ‘this’, dentro un sotto-oggetto chiamato ‘props’ //?questa e quella corretta
